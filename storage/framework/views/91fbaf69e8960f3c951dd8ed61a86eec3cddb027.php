...
<?php endif; ?>
    <form name="sd" method="POST" action="<?php echo e(route('asignaturas.update', $asignatura)); ?>" class=" p-4 bg-secondary text-light">
        <?php echo csrf_field(); ?>
        <?php echo method_field("PUT"); ?>
        <?php app(\ProtoneMedia\LaravelFormComponents\FormDataBinder::class)->bind($asignatura); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\srv\laravel\profesores\academia\resources\views/asignaturas/edit.blade.php ENDPATH**/ ?>